...
export const MatchListTeams = ({ match }: { match: IMatch }) => {
    return (
        <div className="flex flex-row justify-between items-center gap-2 pb-2 border-b-2 border-gray-200 md:col-span-2 md:col-start-1 md:border-b-0 md:border-r-2 md:pb-0 md:pr-2 py-2">
