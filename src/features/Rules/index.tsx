...
export const Rules = () => {
    return (
        <div className="container px-4 py-12 mx-auto mt-10">
            <h1 className="text-4xl font-extrabold mb-6">Game Rules</h1>
                ...
                <li>
                    ...
                    <ol className="ml-4 list-disc list-inside">
                        ...
                        <li className="font-bold">
                            ...
                            completion of Match 35. You can use the Update
                            Profile button under your profile (on top right
                            corner).
                        </li>
                        <li>
            ...
            <h1 className="text-4xl font-extrabold mt-8">Play Bold !!</h1>
        </div>
    );
};
