...
class PredictionAllInfoSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        match = attrs.get("matchNum",self.instance.match)
        ...
        if self.instance:
            ...
            # After match started
            if match.started:
                raise serializers.ValidationError("Cutoff passed for prediction")
    ...
    def create(self, validated_data):
        ...
        instance = Prediction.objects.create(user=user,match=match, team=team,**validated_data)
        return instance
